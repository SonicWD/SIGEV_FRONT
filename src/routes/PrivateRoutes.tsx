...
import GestionMedicos from "@/views/private/Medicos";
import GestionUsuarios from "@/views/private/Usuarios";
...
export default function PrivateRoutes() {
  ...
  return (
    <Suspense
      fallback={
        <div className="text-center mt-10 text-emerald-600">Cargando...</div>
      }
    >
      <Routes>
        ...
        <Route
          path="/registrar-vacunacion"
          element={<div>Registrar Vacunación</div>}
        />
        <Route
          path="/historial"
          element={<div>Historial de Vacunaciones</div>}
        />
